...
<section class="w-1/2">
    ...
    <form method="post" action="{{ route('profile.upload') }}" enctype="multipart/form-data" class="mt-6 space-y-6">
        ...
        <img src="{{ $user->avatarUrl() }}" class="rounded-full w-32" alt="Avatar" />

        <div class="flex">
            <div class="mb-3 w-96">
                <label for="formFile" class="form-label inline-block mb-2 text-gray-700">Chose your photo</label>
                <input class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding
                    ...
                    focus:border-blue-600 focus:outline-none" type="file" id="formFile" name="avatar">
            </div>
        </div>
